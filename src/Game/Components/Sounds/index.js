...
export {CutAudio, DiceAudio, FinishAudio, LoseAudio, SafeAudio, StepAudio, WinAudio};
export default () => {
	return {CutAudio, DiceAudio, FinishAudio, LoseAudio, SafeAudio, StepAudio, WinAudio};
};
